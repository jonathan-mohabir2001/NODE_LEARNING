...
/*
The statment above: 
Is utilizing the USE method of express, and is assigned two parameters ( everything from the home page, and then is assigned 
  routing functionaity through the ROUTER constant. )
*/
